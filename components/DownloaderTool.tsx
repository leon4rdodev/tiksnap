        ...
        <>
          ...
          <div className="pt-6 grid grid-cols-3 gap-2 md:gap-4 text-center">
            <div className="flex flex-col items-center space-y-1">
              ...
              <p className="font-semibold text-sm md:text-base leading-tight">Sin Marca de Agua</p>
            ...
            <div className="flex flex-col items-center space-y-1">
              ...
              <p className="font-semibold text-sm md:text-base leading-tight">Audio en MP3</p>
              <p className="text-xs text-gray-400 leading-tight">
