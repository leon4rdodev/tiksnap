      ...
      <section className="w-full max-w-3xl mx-auto pt-8 md:pt-16 pb-20">
        ...
        <div className="space-y-8">
          ...
          <section className="space-y-3">
            ...
            <ol className="list-decimal list-inside space-y-2 pl-4 text-sm md:text-base text-gray-400">
              <li>Identificación de la obra protegida por derechos de autor que consideras ha sido infringida</li>
              <li>Descripción del material que consideras infractor y su ubicación en nuestro sitio</li>
              ...
              <li>Una declaración bajo pena de perjurio de que la información en tu notificación es exacta</li>
              <li>Tu firma física o electrónica</li>
            </ol>
            <p className="text-sm md:text-base text-gray-400 leading-relaxed mt-3">
          ...
          <section className="space-y-3">
            ...
            <div className="border border-yellow-700/50 rounded-xl p-6">
              <p className="text-yellow-200 leading-relaxed text-sm md:text-base">
            ...
            <ul className="list-disc list-inside space-y-2 pl-4 text-sm md:text-base text-gray-400">
              <li>Daños directos, indirectos, incidentales, especiales o consecuentes derivados del uso o la imposibilidad de usar el Servicio</li>
              <li>La precisión, integridad o utilidad de la información proporcionada por el Servicio</li>
              <li>Interrupciones, errores, virus u otros elementos nocivos que puedan afectar tu dispositivo</li>
              <li>El contenido de los videos descargados, que es responsabilidad exclusiva de los creadores originales y de TikTok</li>
              <li>Las acciones de los usuarios con el contenido descargado a través de nuestro Servicio</li>
            </ul>
          </section>

          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white">7. Indemnización</h2>
            <p className="text-sm md:text-base text-gray-400 leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white">11. Divisibilidad</h2>
            <p className="text-sm md:text-base text-gray-400 leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white">12. Acuerdo Completo</h2>
            <p className="text-sm md:text-base text-gray-400 leading-relaxed">
